...
import corp from '../images/corp1.png';
import custom from '../images/custom1.png';
import ecomm from '../images/e-comm1.png';
  ...
  return (
    <div>
      ...
      <section className="wd_top_section" style={{ backgroundImage: `url(${heroImage})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        ...
        <button onClick={handleContactClick}>Contact Us</button> {/* Updated button */}
      </section>
      ...
      <section className="wb_services">
        ...
        <div className="wb_services2">
          {services.map((e, i) => (
            <div className="wb_services21" key={i}>
              <img src={e.image} alt="" />
              <h3>{e.name}</h3>
              <p>{e.desc}</p>
            </div>
